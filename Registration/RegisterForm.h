...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(397, 25);
			...
			this->label2->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(192)), static_cast<System::Int32>(static_cast<System::Byte>(192)),
				static_cast<System::Int32>(static_cast<System::Byte>(255)));
			this->label2->Location = System::Drawing::Point(275, 169);
			...
			// tbName
			// 
			this->tbName->Location = System::Drawing::Point(559, 169);
			this->tbName->Name = L"tbName";
			this->tbName->Size = System::Drawing::Size(437, 37);
			...
			this->label3->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(192)), static_cast<System::Int32>(static_cast<System::Byte>(192)),
				static_cast<System::Int32>(static_cast<System::Byte>(255)));
			this->label3->Location = System::Drawing::Point(275, 224);
			...
			// tbEmail
			// 
			this->tbEmail->Location = System::Drawing::Point(559, 224);
			this->tbEmail->Name = L"tbEmail";
			this->tbEmail->Size = System::Drawing::Size(437, 37);
			...
			this->label4->Location = System::Drawing::Point(275, 279);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(97, 31);
			this->label4->TabIndex = 1;
			this->label4->Text = L"Phone";
			// 
			// tbPhone
			// 
			this->tbPhone->Location = System::Drawing::Point(559, 279);
			this->tbPhone->Name = L"tbPhone";
			this->tbPhone->Size = System::Drawing::Size(437, 37);
			...
			this->label5->Location = System::Drawing::Point(275, 337);
			...
			// tbAddress
			// 
			this->tbAddress->Location = System::Drawing::Point(559, 331);
			this->tbAddress->Name = L"tbAddress";
			this->tbAddress->Size = System::Drawing::Size(437, 37);
			this->tbAddress->TabIndex = 2;
			this->tbAddress->Text = L"";
			// 
			// label6
			// 
			this->label6->AutoSize = true;
			this->label6->Location = System::Drawing::Point(275, 397);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(142, 31);
			this->label6->TabIndex = 1;
			this->label6->Text = L"Password";
			// 
			// tbPassword
			// 
			this->tbPassword->Location = System::Drawing::Point(559, 391);
			this->tbPassword->Name = L"tbPassword";
			this->tbPassword->PasswordChar = '*';
			this->tbPassword->Size = System::Drawing::Size(437, 37);
			...
			this->label7->Location = System::Drawing::Point(275, 453);
			...
			// tbConfirmPassword
			// 
			this->tbConfirmPassword->Location = System::Drawing::Point(559, 453);
			this->tbConfirmPassword->Name = L"tbConfirmPassword";
			this->tbConfirmPassword->PasswordChar = '*';
			this->tbConfirmPassword->Size = System::Drawing::Size(437, 37);
			this->tbConfirmPassword->TabIndex = 2;
			this->tbConfirmPassword->Text = L"";
			// 
			// btnOK
			// 
			this->btnOK->BackColor = System::Drawing::SystemColors::ActiveCaption;
			this->btnOK->Location = System::Drawing::Point(610, 550);
			...
			this->btnCancel->Location = System::Drawing::Point(795, 550);
			...
			this->llLogin->LinkColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(128)), static_cast<System::Int32>(static_cast<System::Byte>(255)),
				static_cast<System::Int32>(static_cast<System::Byte>(255)));
			this->llLogin->Location = System::Drawing::Point(800, 646);
			this->llLogin->Name = L"llLogin";
			this->llLogin->Size = System::Drawing::Size(430, 31);
			this->llLogin->TabIndex = 4;
			this->llLogin->TabStop = true;
			this->llLogin->Text = L"Already have an account\? Login";
			...
			this->ClientSize = System::Drawing::Size(1258, 720);
...
#pragma endregion
	...
	private: System::Void btnOK_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		try {
			String^ connString = "Data Source=localhost\\sqlexpress;Initial Catalog=registrationdetail;Integrated Security=True";
